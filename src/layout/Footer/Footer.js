	...
	return (
		<footer>
				...
				<div className="row footer">
					<div className="col-md-4">
						...
						<ul>
							...
							? items.map(item => 
								(
									<li>
										<Link href="/" to={ item.slug } key={ item.id } spy={true} offset={-70} duration={500}>{ item.menuitem }</Link>
									</li>
								)
							) 
							: '' }
					...
					<div className="col-md-4">
						...
						<ul>
							...
							<li>
								<a href={ `mailto:${contact.find(item => item.label === 'email').value}` } target="_blank">
			...
			<div className="sub-footer">
				Copyright 2022 &copy; Todos los derechos reservados
			</div>
		</footer>
	);
}
